...
function Sidebar({
  ...
  if (isMobile) {
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          side={side}
          className="w-[90vw] border-l-0 bg-black/60 p-0 text-white backdrop-blur-xl"
        >
  ...
  return (
    <div
      className={cn(
        "group peer fixed inset-y-0 z-30 hidden h-svh w-[var(--sidebar-width)] flex-col md:flex",
